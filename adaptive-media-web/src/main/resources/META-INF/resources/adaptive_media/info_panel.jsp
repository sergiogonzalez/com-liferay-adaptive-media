...
<%
List<AdaptiveMediaImageConfigurationEntry> selectedAMImageConfigurationEntries = (List)request.getAttribute(AdaptiveMediaWebKeys.SELECTED_CONFIGURATION_ENTRIES);
