...
<%
List<AdaptiveMediaImageConfigurationEntry> selectedConfigurationEntries = (List)request.getAttribute(AdaptiveMediaWebKeys.CONFIGURATION_ENTRIES_LIST);
%>
	...
	<div class="sidenav-content">
		...
		<c:choose>
			<c:when test='<%= SessionMessages.contains(request, "configurationEntryUpdated") %>'>
				...
				<%
				AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(request, "configurationEntryUpdated");
				%>
