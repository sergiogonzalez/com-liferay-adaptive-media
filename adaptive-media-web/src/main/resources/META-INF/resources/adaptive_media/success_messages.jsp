...
<liferay-ui:success key="configurationEntriesDeleted">
	...
	<%
	List<AdaptiveMediaImageConfigurationEntry> amImageConfigurationEntries = (List<AdaptiveMediaImageConfigurationEntry>)SessionMessages.get(renderRequest, "configurationEntriesDeleted");
	%>
...
<liferay-ui:success key="configurationEntryAdded">
	...
	<%
	AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(renderRequest, "configurationEntryAdded");
	%>
...
<liferay-ui:success key="configurationEntryAddedAndIDRenamed">
	...
	<%
	AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(renderRequest, "configurationEntryAddedAndIDRenamed");
	%>
...
<liferay-ui:success key="configurationEntryEnabled">
	...
	<%
	AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(renderRequest, "configurationEntryEnabled");
	%>
...
<liferay-ui:success key="configurationEntryDisabled">
	...
	<%
	AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(renderRequest, "configurationEntryDisabled");
	%>
...
<liferay-ui:success key="configurationEntryUpdated">
	...
	<%
	AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(renderRequest, "configurationEntryUpdated");
	%>
...
<liferay-ui:success key="configurationEntryUpdatedAndIDRenamed">
	...
	<%
	AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)SessionMessages.get(renderRequest, "configurationEntryUpdatedAndIDRenamed");
	%>
