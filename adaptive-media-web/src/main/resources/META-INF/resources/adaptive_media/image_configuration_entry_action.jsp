...
AdaptiveMediaImageConfigurationEntry amImageConfigurationEntry = null;

if (row != null) {
	amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)row.getObject();
}
else {
	amImageConfigurationEntry = (AdaptiveMediaImageConfigurationEntry)request.getAttribute("info_panel.jsp-amImageConfigurationEntry");
}
