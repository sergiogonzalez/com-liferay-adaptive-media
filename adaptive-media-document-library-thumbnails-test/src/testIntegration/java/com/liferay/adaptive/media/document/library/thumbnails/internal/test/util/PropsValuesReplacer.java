...
public class PropsValuesReplacer implements AutoCloseable {
	...
	public PropsValuesReplacer(String name, Object value) throws Exception {
		_propsKeysField = ReflectionUtil.getDeclaredField(
			PropsKeys.class, name);

		_propsKeysName = (String)_propsKeysField.get(null);
	...
	public void close() throws Exception {
		...
		ReflectionUtil.unfinalField(_propsKeysField);
		ReflectionUtil.unfinalField(_propsValuesField);
	}

	private final Field _propsKeysField;
